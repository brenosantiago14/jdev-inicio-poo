...
public class PrimeiraClasseJava {
	...
	public static void main(String[] args) {
		 ...
		 * nascimento = JOptionPane.showInputDialog("Data de nascimento?"); String rg =
		 ...
		 * JOptionPane.showInputDialog("Série matriculado(a)"); String escola =
		 * JOptionPane.showInputDialog("Nome da escola?"); String nota1 =
		 * JOptionPane.showInputDialog("Nota 1?"); String nota2 =
		 * JOptionPane.showInputDialog("Nota 21?"); String nota3 =
		 * JOptionPane.showInputDialog("Nota 3?"); String nota4 =
		 * JOptionPane.showInputDialog("Nota 4?");
		 * 
		 * Aluno aluno3 = new Aluno(); aluno3.setNome(nome);
		 * aluno3.setIdade(Integer.valueOf(idade));
		 * aluno3.setDataNascimento(nascimento); aluno3.setRegistroGeral(rg);
		 * aluno3.setNumeroCpf(cpf); aluno3.setNomePai(nomePai);
		 * aluno3.setNomeMae(nomeMae); aluno3.setSerieMatriculado(serieMatriculado);
		 * aluno3.setNomeEscola(escola); aluno3.setNota1(Double.parseDouble(nota1));
		...
		if(aluno1.equals(aluno2)) {
			System.out.println("Os alunos têm o mesmo nome. São iguais.");
		}else {
